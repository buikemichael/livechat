...
export default function Profile({currentuser}) {
    return (
        <>
            <div className="d-none cu-col-12 cu-col-md-5 cu-col-lg-4 cu-col-xl-3 px-4 px-sm-5 px-lg-4 user-profile">
                ...
                <div className="user-profile__wrapper">
                    ...
                    <div className="user-profile__details mt-1">
                        <span className="user-profile__name">{currentuser?.friendData?.username}</span>
