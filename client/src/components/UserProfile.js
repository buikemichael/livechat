...
export default function UserProfile({ userprofile, toggleuserprofile,handleusertoggleprofile }) {
    return (
        <>
            <div className={`user-profile user__profile__open p-4 ${toggleuserprofile ? 'open__profile' : ''}`}>
                <div className="user-profile__close d-flex" onClick={()=>handleusertoggleprofile()}>
                ...
                <div className="user-profile__wrapper">
                    ...
                    <div className="user-profile__details mt-1">
                        <span className="user-profile__name">{userprofile.username}</span>
